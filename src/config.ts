...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		homeText: {
			...
			title: "乄轩丶辕°のHouseヾ(๑╹ヮ╹๑)ﾉ", // 主页横幅主标题

			subtitle: [
				"Rage Your Dream",
				"无论发生什么，请不要后悔与我的相遇!",
				"即使世界上只剩孤独的我，也不会忘记曾经的感动，孤身一人也要继续前进，怀抱希望，继续前进。",
				"无论是怎样残酷的，惨淡的，悲伤的，不公的人生，这都是你努力活过的人生，没有半点虚假和妥协，我不愿歌颂苦难，但我也不愿忽视自己狼狈的坚持与抗争。",
			],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/JinHao0007",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/527114995",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	title: "个人说明", // 公告标题
	content: "泥嚎~这里是轩辕~，是一名大学牲，想成为技术宅。Ciallo～(∠・ω< )⌒★", // 公告内容
